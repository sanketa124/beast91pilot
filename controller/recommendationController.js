...
exports.completedEvents=async(req,res,next)=>{
    ...
    try{
        ...
        const result= await conn.query(`SELECT Account__c, COUNT(Id)  FROM Event__c  where  CALENDAR_MONTH(Start_Date__c)=${month} and RecordTypeId='${recordTypeId}' and Completed__c=true GROUP BY Account__c`)
